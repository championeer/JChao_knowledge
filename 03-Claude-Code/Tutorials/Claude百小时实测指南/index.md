...
source: "https://x.com/yanhua1010/status/2029748928091148665"
author:
  - "[[Unknown]]"
...
![图像](https://pbs.twimg.com/media/HCsaW4dbMAA00Yk?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCsaflwbEAEi8o6?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCsakSYaUAIiNh1?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCsapajbEAAmSlK?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCsbItAbsAAjGib?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCsaujIaUAAjKLl?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCsbO8yaUAQ8fTr?format=jpg&name=large)
...
> 2月16日
> 
> 推荐一下我目前Claude Code安装的8个的插件： 基本涵盖了开发、CR、Github commit的整个流程，也是Anthropic官方推荐的，尤其第一个插件，超过18万安装 frontend-design 用于 UI/UX 实现的前端设计技能 context7 Upstash Context7 MCP

## Cowork 插件

![图像](https://pbs.twimg.com/media/HCsbUuWa0AAl01H?format=jpg&name=large)
