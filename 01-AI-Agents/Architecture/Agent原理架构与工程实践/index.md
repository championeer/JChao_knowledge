...
![图像](https://pbs.twimg.com/media/HDszQMIa0AETkbp?format=jpg&name=large)

Agent 能改的只有 [train.py](https://train.py/) 这个文件，评估指标固定为 bits-per-byte，也就是 bpb，越低越好。每次实验最多跑 5 分钟，结果更好就 commit 作为新基准，结果变差就直接 revert。所有实验结果记录在 results.tsv 中，不进入 git 历史。整个系统的控制平面是 program.md，相当于 Agent 的操作手册，里面定义了工作流程、可修改的文件边界、日志格式和崩溃恢复步骤，其中几条设计很值得参考：

1. **单文件搜索空间**：Agent 只能修改 [train.py](https://train.py/)，数据处理和评估脚本保持只读，避免通过修改评估逻辑来刷分。
...
![图像](https://pbs.twimg.com/media/HDszm_9bAAAJIsg?format=jpg&name=large)
...
1. OpenAI, [Harness engineering: leveraging Codex in an agent-first world](https://openai.com/index/harness-engineering/), 2026-02-18OpenAI [驾驭工程：在以代理为先的世界中利用 Codex](https://openai.com/index/harness-engineering/) 2026 年 2 月 18 日
2. Anthropic, [Building a C compiler with a team of parallel Claudes](https://www.anthropic.com/engineering/building-c-compiler), 2026-02-05人类的， [用并行计算团队构建 C 编译器](https://www.anthropic.com/engineering/building-c-compiler) 2026 年 2 月 5 日
3. Andrej Karpathy, [karpathy/autoresearch](https://github.com/karpathy/autoresearch), 2025安德烈·卡帕蒂[业力/自我研究](https://github.com/karpathy/autoresearch) 2025 年
4. Cloudflare, [How we rebuilt Next.js with AI in one week](https://blog.cloudflare.com/vinext/), 2026-02-17Cloudflare， [我们如何在短短一周内利用人工智能重建 Next.js](https://blog.cloudflare.com/vinext/) 2026 年 2 月 17 日
5. Simon Willison, [I ported JustHTML from Python to JavaScript with Codex CLI](https://simonwillison.net/2025/Dec/15/porting-justhtml/), 2025-12-15西蒙·威利森[我使用 Codex CLI 将 JustHTML 从 Python 移植到了 JavaScript。](https://simonwillison.net/2025/Dec/15/porting-justhtml/) 2025 年 12 月 15 日
6. Anthropic, [Introducing Agent Skills](https://claude.com/blog/skills), 2025-10-16人类的， [介绍代理技能](https://claude.com/blog/skills) 2025 年 10 月 16 日
7. Anthropic, [Managing context on the Claude Developer Platform](https://claude.com/blog/context-management), 2025-09-29人类的， [在 Claude 开发者平台上管理上下文](https://claude.com/blog/context-management) 2025 年 9 月 29 日
8. LangChain, [State of Agent Engineering](https://www.langchain.com/state-of-agent-engineering), 2026LangChain， [代理工程现状](https://www.langchain.com/state-of-agent-engineering) 2026 年
9. Anthropic, [Measuring AI agent autonomy in practice](https://www.anthropic.com/research/measuring-agent-autonomy), 2026-02-18人类的， [实际测量人工智能代理的自主性](https://www.anthropic.com/research/measuring-agent-autonomy) 2026 年 2 月 18 日
10. OpenAI, [Designing AI agents to resist prompt injection](https://openai.com/index/designing-agents-to-resist-prompt-injection/), 2026-03-11OpenAI [设计人工智能代理以抵抗快速注射](https://openai.com/index/designing-agents-to-resist-prompt-injection/) 2026 年 3 月 11 日
11. Anthropic, [Demystifying evals for AI agents](https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents), 2025-09-17人类的， [揭秘人工智能代理的评估](https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents) 2025 年 9 月 17 日