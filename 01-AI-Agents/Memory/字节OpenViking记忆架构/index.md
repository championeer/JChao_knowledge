...
每条记忆都打标签，[memory-janitor.py记忆管理员.py](https://memory-janitor.py/) 每天凌晨自动扫描，过期的 P1/P2 移到 archive/。

**解决的问题：** 记忆不会无限膨胀，过期的自动归档。

**没解决的问题：** 即使没过期，[MEMORY.md](https://memory.md/) 也越来越大，每次全读太浪费。Bot 每次启动都要读 [MEMORY.md](https://memory.md/)MEMORY.md 全文，这文件已经 8000+ tokens 了。
