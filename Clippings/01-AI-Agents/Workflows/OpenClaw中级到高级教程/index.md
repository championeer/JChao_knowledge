...
如果上述条件尚未满足，建议先阅读 [https://x.com/onehopeA9/status/2025934420893708433](https://x.com/onehopeA9/status/2025934420893708433)
...
![图像](https://pbs.twimg.com/media/HCD2FYGboAA4SWT?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCD30UgbYAA-vSZ?format=jpg&name=large)

**关于 softThresholdTokens:关于 so​​ftThresholdTokens:**
...
![图像](https://pbs.twimg.com/media/HCD5YFsaMAAEDsj?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCD58e3aMAE79i3?format=png&name=large)
...
- **即时通讯**：Telegram、Discord、Slack、WhatsApp**即时通讯** ：Telegram、Discord、Slack、WhatsApp
- **社交媒体**：Twitter、微信（通过第三方桥接）
- **Web 接口**：WebChat、HTTP API**Web 接口** ：WebChat、HTTP API
- **本地接口**：CLI 命令行
...
![图像](https://pbs.twimg.com/media/HCD8QmdaMAMpv90?format=jpg&name=large)
...
- **GitHub 仓库**：[github.com/openclaw/openclaw](https://github.com/openclaw/openclaw)**GitHub 仓库** ： [github.com/openclaw/openclaw](https://github.com/openclaw/openclaw)
- **官方文档**：[docs.openclaw.ai](https://docs.openclaw.ai/)
- **Skill 市场**：[github.com/VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)**Skill 市场** ： [github.com/VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)

**社区资源**

- **Reddit**:r/clawdbot、r/AiForSmallBusiness**Reddit** ：r/clawdbot、r/AiForSmallBusiness
- **Discord**:OpenClaw 官方 Discord 服务器**Discord** :OpenClaw 官方 Discord 服务器
