---
title: "5 Agent Skill design patterns every ADK developer should know每位 ADK 开发人员都应该了解的 5 种代理技能设计模式"
...
**By** [@Saboo\_Shubham\_](https://x.com/@Saboo_Shubham_) **and** **经过** [@Saboo\_Shubham\_](https://x.com/@Saboo_Shubham_) **和** [@lavinigam](https://x.com/@lavinigam)[@lavinigam](https://x.com/@lavinigam)
...
![图像](https://pbs.twimg.com/media/HDoDgs6XAAYtw04?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDoDoIeXAAUmQoy?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDoEJdZbEAEdYMo?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDoEa51XEAIKSnO?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDoEo5XbEAUaaFG?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDoE195bEAABitY?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDoFWovXAAsbb8C?format=jpg&name=large)
...
The Agent Skills specification is open-source and natively supported across ADK. You already know how to package the format. Now you know how to design the content. Go build smarter agents with [Google Agent Development Kit](https://google.github.io/adk-docs/).代理技能规范是开源的，并且在 ADK 中得到原生支持。您已经知道如何打包格式。现在您知道如何设计内容了。开始使用它们构建更智能的代理吧！ [Google Agent 开发工具包](https://google.github.io/adk-docs/) 。