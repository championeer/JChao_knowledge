---
title: "一个免费数据库让你的龙虾成为精简版“彭博终端”"
source: "https://x.com/xingpt/status/2032021921022529794"
author:
  - "[[Unknown]]"
...
正好在大神 [@0xcherry](https://x.com/@0xcherry) 的文章里发现他在用OpenBB数据库，试了一下效果还挺好，满足基础投研需求肯定是没问题了。

## 什么是 OpenBB？

OpenBB 是一个开源的金融数据平台，被称为“穷人版彭博终端”。它整合了近 100 个数据源，包括股票、期权、加密货币、外汇、宏观经济等各类金融数据。最关键的是——**完全开源免费**。

OpenBB 采用“一次连接，到处使用”的架构设计，让开发者、分析师，**以及AI Agent**可以通过 Python、REST API、Excel 等多种方式访问数据，非常适合接入到各类应用和工具中。
...
![图像](https://pbs.twimg.com/media/HDMYyADasAAmHRF?format=jpg&name=large)
...
就这三步，简不简单！Openclaw 会自动调用 OpenBB 获取数据并给你答案。 我们来看一下OpenBB究竟提供哪些金融数据，以便更好地向他提问
...
![图像](https://pbs.twimg.com/media/HDMaCjGbQAAhyJ3?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDMaHGHbsAAtNAz?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDMiEN-bQAckKbJ?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDMlxbLaQAEH2Qo?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HDMin52bQAUDEOf?format=jpg&name=large)
