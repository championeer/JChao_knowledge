...
# 2\. 概念边界：MCP / Plugin / Tools / Skills / Hooks / Subagents2. 边界概念：MCP / Plugin / Tools / Skills / Hooks / Subagents
...
- 一个 Skill 覆盖 review、deploy、debug、docs、incident 五件事一个技能覆盖 review、deploy、debug、docs、incident 五件事
...
- 对大响应支持 response\_format: concise / detailed对大电影手机手机 response\_format：简洁/详细
...
Hooks + Skills + CLAUDE.md 三层叠加Hooks + Skills + CLAUDE.md 三层支撑
...
> "Update your CLAUDE.md so you don't make that mistake again."“请更新您的 CLAUDE.md 文件，以免再次犯同样的错误。”
...
> npx skills add tw93/claude-healthnpx 技能添加 tw93/claude-health
