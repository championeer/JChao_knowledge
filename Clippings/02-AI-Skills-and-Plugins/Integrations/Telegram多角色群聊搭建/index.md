...
source: "https://x.com/berryxia/status/2029950589313101902"
author:
  - "[[Unknown]]"
...
如果你对配置小龙虾还不了解，可以查看上期：**OpenClaw养成记，从0开始！安装后必看！（40天实战经验+含角色提示词）**容：[https://x.com/berryxia/status/2028668902465733084](https://x.com/berryxia/status/2028668902465733084)

## 先说结论

![图像](https://pbs.twimg.com/media/HCvMYysaUAQ4QzG?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvMnYeboAAk4Sk?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvNHKVaQAAHk3W?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvNSwXasAAVxko?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvNWrsbUAE3pBm?format=jpg&name=large)

第一步：创建主 Bot（5分钟）

这一步是基础。你需要创建一个"主控 Bot"，它就是所有子 Agent 的"宿主"。

1. 在 Telegram 搜索 [@BotFather](https://x.com/@BotFather)，发送 /newbot在 Telegram 搜索 [@BotFather](https://x.com/@BotFather) ，发送/newbot

![图像](https://pbs.twimg.com/media/HCvN3whaUAIH7n5?format=jpg&name=large)

创建主BOT

1. 给 Bot 起个名字（比如 lifezhushou）
2. 设置用户名（必须以 bot 结尾，比如 lifezhushou\_bot）
3. **复制返回的 Token**（长得像 123456:ABC-DEF...）

![图像](https://pbs.twimg.com/media/HCvOGXeaUAkyOFJ?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvdrNUbsAAVDb-?format=jpg&name=large)
...
回到 [@BotFather](https://x.com/@BotFather)返回 [@BotFather](https://x.com/@BotFather)

设置BotSetting设置机器人设置

![图像](https://pbs.twimg.com/media/HCvPA9qbgAEJgZn?format=jpg&name=large)

设置BotSetting

群聊隐私设置

![图像](https://pbs.twimg.com/media/HCvPFECasAAQqzv?format=jpg&name=large)

群聊隐私设置

关闭隐私模式

![图像](https://pbs.twimg.com/media/HCvPJu9a0AEmHsC?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvPVFAaUAAmD4Y?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvPccEaUAAGNNi?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvPoxKaUAkK799?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvP3gRbQAAczUW?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvQji2aIAAzlXS?format=jpg&name=large)
...
- 所有Bot都设置 requireMention: true所有 Bot 都设置 requireMention: true
- 叫谁谁回答
...
![图像](https://pbs.twimg.com/media/HCvQ6XZaUAQkHt9?format=png&name=large)

自己可以不看告诉OpenClaw去做

## 记忆隔离

![图像](https://pbs.twimg.com/media/HCvRCwIbMAAEw6N?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HCvRIt6aUAgLfJh?format=jpg&name=large)

检查清单：

![图像](https://pbs.twimg.com/media/HCvRO0IaUAUsAGZ?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HCvR6i8aUAEOVFn?format=jpg&name=large)
...
作者：[Berryxia.ai](https://berryxia.ai/)作者： [Berryxia.ai](https://berryxia.ai/)
