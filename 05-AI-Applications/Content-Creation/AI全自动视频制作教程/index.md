...
created: 2026-05-10
description: "想让 AI帮你全自动生成并渲染视频吗？结合 Codex AI编程助手与Remotion React视频框架，你可以搞建一套完整的自动化工作流：让 AI自动读取本地素材、编写视频组件代码，并一键渲染成最终的 MP4文件。这份保姆级教程将带你从零跑通全流程。一 它是如何工作的？Rem..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HHuAYjJbIAE7xh3?format=jpg&name=large)

想让 AI帮你全自动生成并渲染视频吗？结合 Codex AI编程助手与Remotion React视频框架，你可以搞建一套完整的自动化工作流：让 AI自动读取本地素材、编写视频组件代码，并一键渲染成最终的 MP4文件。
